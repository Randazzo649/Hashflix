...
import ra.catalogo.estruturas.TabelaHashFilmes;
...
public class JanelaPrincipal {
    ...
    private static final TabelaHashFilmes tabelaHash = new TabelaHashFilmes(20);
    ...
    public static Scene getInterface() {
        ...
        btnBuscar.setOnAction(e -> {
            ...
            Filme encontrado = tabelaHash.buscarPorNome(titulo);
            if (encontrado != null) {
    ...
    private static void abrirJanelaAdicionar() {
